 ...
 */
@Configuration
@ComponentScan(value="jp.co.jwebgate.jlibrary.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new jp.co.jwebgate.jlibrary.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new jp.co.jwebgate.jlibrary.dbflute.allcommon.ImplementedInvokerAssistant();
    }
