...
/**
 * The abstract condition-query of GENERAL_USER.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsGeneralUserCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsGeneralUserCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * GENERAL_USER_ID: {PK, UQ, NotNull, VARCHAR(10)} <br>
     ...
     * {exists (select GENERAL_USER_ID from USER_ROLE_MAP where ...)} <br>
     * USER_ROLE_MAP by GENERAL_USER_ID, named 'userRoleMapAsOne'.
     * <pre>
    ...
    public void existsUserRoleMap(SubQuery<UserRoleMapCB> subCBLambda) {
        ...
        lockCall(() -> subCBLambda.query(cb)); String pp = keepGeneralUserId_ExistsReferrer_UserRoleMapList(cb.query());
        registerExistsReferrer(cb.query(), "GENERAL_USER_ID", "GENERAL_USER_ID", pp, "userRoleMapList");
    }
    public abstract String keepGeneralUserId_ExistsReferrer_UserRoleMapList(UserRoleMapCQ sq);

    /**
     * Set up NotExistsReferrer (correlated sub-query). <br>
     * {not exists (select GENERAL_USER_ID from USER_ROLE_MAP where ...)} <br>
     * USER_ROLE_MAP by GENERAL_USER_ID, named 'userRoleMapAsOne'.
     * <pre>
     ...
     * });
     * </pre>
     * @param subCBLambda The callback for sub-query of GeneralUserId_NotExistsReferrer_UserRoleMapList for 'not exists'. (NotNull)
     */
    public void notExistsUserRoleMap(SubQuery<UserRoleMapCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        UserRoleMapCB cb = new UserRoleMapCB(); cb.xsetupForExistsReferrer(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepGeneralUserId_NotExistsReferrer_UserRoleMapList(cb.query());
        registerNotExistsReferrer(cb.query(), "GENERAL_USER_ID", "GENERAL_USER_ID", pp, "userRoleMapList");
    }
    public abstract String keepGeneralUserId_NotExistsReferrer_UserRoleMapList(UserRoleMapCQ sq);
    ...
    public void xsderiveUserRoleMapList(String fn, SubQuery<UserRoleMapCB> sq, String al, DerivedReferrerOption op) {
        ...
        lockCall(() -> sq.query(cb)); String pp = keepGeneralUserId_SpecifyDerivedReferrer_UserRoleMapList(cb.query());
        registerSpecifyDerivedReferrer(fn, cb.query(), "GENERAL_USER_ID", "GENERAL_USER_ID", pp, "userRoleMapList", al, op);
    }
    public abstract String keepGeneralUserId_SpecifyDerivedReferrer_UserRoleMapList(UserRoleMapCQ sq);
    ...
    public void xqderiveUserRoleMapList(String fn, SubQuery<UserRoleMapCB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        UserRoleMapCB cb = new UserRoleMapCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String sqpp = keepGeneralUserId_QueryDerivedReferrer_UserRoleMapList(cb.query()); String prpp = keepGeneralUserId_QueryDerivedReferrer_UserRoleMapListParameter(vl);
        registerQueryDerivedReferrer(fn, cb.query(), "GENERAL_USER_ID", "GENERAL_USER_ID", sqpp, "userRoleMapList", rd, vl, prpp, op);
    }
    public abstract String keepGeneralUserId_QueryDerivedReferrer_UserRoleMapList(UserRoleMapCQ sq);
    public abstract String keepGeneralUserId_QueryDerivedReferrer_UserRoleMapListParameter(Object vl);
     ...
     * @param phoneNumber The value of phoneNumber as equal. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * NotEqual(&lt;&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PHONE_NUMBER: {NotNull, VARCHAR(11)}
     * @param phoneNumber The value of phoneNumber as notEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * GreaterThan(&gt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PHONE_NUMBER: {NotNull, VARCHAR(11)}
     * @param phoneNumber The value of phoneNumber as greaterThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * LessThan(&lt;). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PHONE_NUMBER: {NotNull, VARCHAR(11)}
     * @param phoneNumber The value of phoneNumber as lessThan. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * GreaterEqual(&gt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PHONE_NUMBER: {NotNull, VARCHAR(11)}
     * @param phoneNumber The value of phoneNumber as greaterEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * LessEqual(&lt;=). And NullOrEmptyIgnored, OnlyOnceRegistered. <br>
     * PHONE_NUMBER: {NotNull, VARCHAR(11)}
     * @param phoneNumber The value of phoneNumber as lessEqual. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
     ...
     * InScope {in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * PHONE_NUMBER: {NotNull, VARCHAR(11)}
     * @param phoneNumberList The collection of phoneNumber as inScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPhoneNumber_InScope(Collection<String> phoneNumberList) {
        doSetPhoneNumber_InScope(phoneNumberList);
    }

    protected void doSetPhoneNumber_InScope(Collection<String> phoneNumberList) {
        regINS(CK_INS, cTL(phoneNumberList), xgetCValuePhoneNumber(), "PHONE_NUMBER");
    }

    /**
     * NotInScope {not in ('a', 'b')}. And NullOrEmptyIgnored, NullOrEmptyElementIgnored, SeveralRegistered. <br>
     * PHONE_NUMBER: {NotNull, VARCHAR(11)}
     * @param phoneNumberList The collection of phoneNumber as notInScope. (basically NotNull, NotEmpty: error as default, or no condition as option)
     */
    public void setPhoneNumber_NotInScope(Collection<String> phoneNumberList) {
        doSetPhoneNumber_NotInScope(phoneNumberList);
    }

    protected void doSetPhoneNumber_NotInScope(Collection<String> phoneNumberList) {
        regINS(CK_NINS, cTL(phoneNumberList), xgetCValuePhoneNumber(), "PHONE_NUMBER");
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PHONE_NUMBER: {NotNull, VARCHAR(11)} <br>
     * <pre>e.g. setPhoneNumber_LikeSearch("xxx", op <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> op.<span style="color: #CC4747">likeContain()</span>);</pre>
     * @param phoneNumber The value of phoneNumber as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setPhoneNumber_LikeSearch(String phoneNumber, ConditionOptionCall<LikeSearchOption> opLambda) {
        setPhoneNumber_LikeSearch(phoneNumber, xcLSOP(opLambda));
    }

    /**
     * LikeSearch with various options. (versatile) {like '%xxx%' escape ...}. And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PHONE_NUMBER: {NotNull, VARCHAR(11)} <br>
     * <pre>e.g. setPhoneNumber_LikeSearch("xxx", new <span style="color: #CC4747">LikeSearchOption</span>().likeContain());</pre>
     * @param phoneNumber The value of phoneNumber as likeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param likeSearchOption The option of like-search. (NotNull)
     */
    protected void setPhoneNumber_LikeSearch(String phoneNumber, LikeSearchOption likeSearchOption) {
        regLSQ(CK_LS, fRES(phoneNumber), xgetCValuePhoneNumber(), "PHONE_NUMBER", likeSearchOption);
    }
     ...
     * And NullOrEmptyIgnored, SeveralRegistered. <br>
     * PHONE_NUMBER: {NotNull, VARCHAR(11)}
     * @param phoneNumber The value of phoneNumber as notLikeSearch. (basically NotNull, NotEmpty: error as default, or no condition as option)
     * @param opLambda The callback for option of like-search. (NotNull)
     */
    public void setPhoneNumber_NotLikeSearch(String phoneNumber, ConditionOptionCall<LikeSearchOption> opLambda) {
        setPhoneNumber_NotLikeSearch(phoneNumber, xcLSOP(opLambda));
    }
     ...
     * @param likeSearchOption The option of not-like-search. (NotNull)
     */
    protected void setPhoneNumber_NotLikeSearch(String phoneNumber, LikeSearchOption likeSearchOption) {
        regLSQ(CK_NLS, fRES(phoneNumber), xgetCValuePhoneNumber(), "PHONE_NUMBER", likeSearchOption);
    }

    protected void regPhoneNumber(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValuePhoneNumber(), "PHONE_NUMBER"); }
    protected abstract ConditionValue xgetCValuePhoneNumber();
     ...
     */
    public HpSLCFunction<GeneralUserCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, GeneralUserCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GeneralUserCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, GeneralUserCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GeneralUserCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, GeneralUserCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GeneralUserCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, GeneralUserCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GeneralUserCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, GeneralUserCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;GeneralUserCB&gt;() {
     *     public void query(GeneralUserCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<GeneralUserCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, GeneralUserCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        GeneralUserCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(GeneralUserCQ sq);

    protected GeneralUserCB xcreateScalarConditionCB() {
        GeneralUserCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected GeneralUserCB xcreateScalarConditionPartitionByCB() {
        GeneralUserCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected GeneralUserCB newMyCB() {
        return new GeneralUserCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return GeneralUserCQ.class.getName(); }
