...
public class BsRoleCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public RoleCB acceptPK(Integer id) {
    ...
    public static class HpSpecification extends HpAbstractSpecification<RoleCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnCd() { return doColumn("CD"); }
        /**
         ...
         */
        public HpSDRFunction<UserRoleMapCB, RoleCQ> derivedUserRoleMap() {
            assertDerived("userRoleMapList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<UserRoleMapCB> sq, RoleCQ cq, String al, DerivedReferrerOption op)
