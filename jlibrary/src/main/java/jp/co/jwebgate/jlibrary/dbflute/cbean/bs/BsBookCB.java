...
public class BsBookCB extends AbstractConditionBean {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected BookCQ _conditionQuery;
     ...
     * @return this. (NotNull)
     */
    public BookCB acceptPK(Integer id, String controlNumber) {
        assertObjectNotNull("id", id);assertObjectNotNull("controlNumber", controlNumber);
        BsBookCB cb = this;
        cb.query().setId_Equal(id);cb.query().setControlNumber_Equal(controlNumber);
        return (BookCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_Id_Asc();
        query().addOrderBy_ControlNumber_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_Id_Desc();
        query().addOrderBy_ControlNumber_Desc();
        return this;
    }
    ...
    public BookCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected BookCQ doGetConditionQuery() {
    ...
    protected BookCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected BookCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        BookCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected BookCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new BookCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<BookCB> unionCBLambda) {
        final BookCB cb = new BookCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final BookCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<BookCB> unionCBLambda) {
        final BookCB cb = new BookCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final BookCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * }).alwaysPresent(<span style="color: #553000">book</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">book</span>.<span style="color: #CC4747">getGenre()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     */
    ...
    public static class HpSpecification extends HpAbstractSpecification<BookCQ> {
        protected GenreCB.HpSpecification _genre;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<BookCQ> qyCall
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnAuthor() { return doColumn("AUTHOR"); }
        /**
         * ISBN_10: {VARCHAR(10)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnIsbn10() { return doColumn("ISBN_10"); }
        /**
         * ISBN_13: {VARCHAR(13)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnIsbn13() { return doColumn("ISBN_13"); }
        /**
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnShelfNumber() { return doColumn("SHELF_NUMBER"); }
        /**
         * CONTROL_NUMBER: {PK, NotNull, VARCHAR(10)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnControlNumber() { return doColumn("CONTROL_NUMBER"); }
        /**
         * REMARKS: {VARCHAR(255)}
         * @return The information object of specified column. (NotNull)
         */
     ...
     */
    public BookCB dreamCruiseCB() {
        BookCB cb = new BookCB();
        cb.xsetupForDreamCruise((BookCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<BookCB> columnQuery(final SpecifyQuery<BookCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected BookCB xcreateColumnQueryCB() {
        BookCB cb = new BookCB();
        cb.xsetupForColumnQuery((BookCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<BookCB> orCBLambda) {
        xorSQ((BookCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<BookCB> andCBLambda) {
        xorSQAP((BookCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return BookCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return BookCQ.class.getName(); }
